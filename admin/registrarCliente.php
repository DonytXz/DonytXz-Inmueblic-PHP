...
<br><br><br><br>
    <form id="trofeo" class="trofeo" method="POST" action="insertarUsuario.php" onsubmit="return valida(this)" enctype="multipart/form-data" >
        <fieldset>
        <legend><h2>Registro Cliente</h2></legend>
        <ol>
       ...
       <li>
        ...
        <li>
            ...
            <input name="txt_nickname" id="nickname"  type="text" maxlength="30" required>
        </li>
        <li>
        ...
        <li>
            ...
            <button id="enviar" type="submit" class="boton boton-verde d-block">Registrar</button>
        </fieldset>
    </form>
	<br><br><br><br>
